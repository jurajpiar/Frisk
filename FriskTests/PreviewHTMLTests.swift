...
final class PreviewHTMLTests: XCTestCase {
    ...
    private func item(_ path: String, size: UInt64 = 10, dir: Bool = false) -> ArchiveEntryItem {
        ArchiveEntryItem(id: path, path: path,
    ...
    func testEscapesScriptAndAmpersandInNames() {
        ...
        let html = ArchiveListingHTML.render(for: entries, name: "evil.zip")
